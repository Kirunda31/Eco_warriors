  ...
  return <div className="mx-auto max-w-5xl space-y-8">
    ...
    <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm"><h2 className="text-xl font-bold">Project details</h2>
      <form action={updateProject} className="mt-5 grid gap-4 md:grid-cols-2"><input type="hidden" name="id" value={project.id} />
        ...
        <label className="grid gap-1 text-sm font-medium">Latitude<input name="latitude" type="number" step="any" defaultValue={project.latitude ?? ''} placeholder="e.g. 0.3476" className="rounded border border-gray-300 px-3 py-2 font-normal" /></label><label className="grid gap-1 text-sm font-medium">Longitude<input name="longitude" type="number" step="any" defaultValue={project.longitude ?? ''} placeholder="e.g. 32.5825" className="rounded border border-gray-300 px-3 py-2 font-normal" /></label>
